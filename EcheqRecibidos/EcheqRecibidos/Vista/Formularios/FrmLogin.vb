...
Public Class FrmLogin
    ...
    Private Sub FrmLogin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Lblestado.Text = "Gestión de ECheques"
        ...
        If My.Computer.Name = "SISTEMAS7" Or My.Computer.Name = "SISTEMAS3" Then 'aca cambie el nombre de SISTEMAS2 a SISTEMAS para que no me tire el combo (07-10-2020)
    ...
    Private Sub CorroborarDatos()
        ...
        Select Case Datos.ValidarPermisos(210, txtUsername.Text, txtPassword.Text, obj)
