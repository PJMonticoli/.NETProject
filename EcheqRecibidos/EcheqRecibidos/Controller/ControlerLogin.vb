...
Public Class ControlerLogin
    ...
    Public Shared Function obtenerVersion() As Boolean
        Dim query = "SELECT version FROM datosguma.dbo.gestiones where codGestion = 113 and version = '27/02/2024'"
    ...
    Public Shared Function obtenerVersion2() As DataTable
        Dim query As String = "SELECT version FROM datosguma.dbo.gestiones where codGestion = 113 and version = '27/02/2024'"
        Dim dt As DataTable = Nothing
        Try
            dt = GetTabla(query)
            If dt.Rows.Count = 0 Then
